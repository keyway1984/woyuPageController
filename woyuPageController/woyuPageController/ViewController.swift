...
extension ViewController: PageControllerDataSource {
    ...
    func pageController(_: PageController, headerForPageAt index: Int) -> PageHeader {
        ...
        header.textFont = UIFont.boldSystemFont(ofSize: 13) // 页眉默认字体
        header.textFontHL = UIFont.boldSystemFont(ofSize: 18) // 页眉被选择后的字体
...
//        line.layer.masksToBounds = true
    ...
    // 允许划页同时自动校正页眉容器
    func pageController(_: PageController, containerAdjustWhenDraggingPage _: PageContainer) -> Bool {
        true
    }
}
